...
```js
import { Client, Config, CreateSubaccountRequestDto } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, GetRequestDto } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, UpdateRequestDto } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, DeleteRequestDto } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, GetStatusRequestDto } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, ChangePasswordRequestDto } from '@community-sdks/godaddy-js';
