...
```js
import { Client, Config, GetMetricsRequestDto } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, GetMetricsByDomainRequestDto } from '@community-sdks/godaddy-js';
