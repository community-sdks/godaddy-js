...
```js
import { Client, Config, CreateCertificateRequest } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, ValidateCertificateRequest } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, GetCertificateRequest } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, ListCertificateActionsRequest } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, ResendCertificateEmailRequest } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, AddAlternateEmailAddressRequest } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, ResendCertificateEmailToAddressRequest } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, GetCertificateEmailHistoryRequest } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, DeleteCertificateCallbackRequest } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, GetCertificateCallbackRequest } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, ReplaceCertificateCallbackRequest } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, CancelCertificateRequest } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, DownloadCertificateRequest } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, ReissueCertificateRequest } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, RenewCertificateRequest } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, RevokeCertificateRequest } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, GetCertificateSiteSealRequest } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, VerifyCertificateDomainControlRequest } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, GetCertificatesByEntitlementRequest } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, CreateCertificateForEntitlementRequest } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, DownloadCertificateByEntitlementRequest } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, ListCustomerCertificatesRequest } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, GetCustomerCertificateRequest } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, ListDomainVerificationsRequest } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, GetDomainVerificationDetailsRequest } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, GetAcmeExternalAccountBindingRequest } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, SearchSubscriptionsByDomainRequest } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, ListSubscriptionCertificatesRequest } from '@community-sdks/godaddy-js';
