...
```js
import { Client, Config, ListRequestDto } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, ProductGroupsRequestDto } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, CancelRequestDto } from '@community-sdks/godaddy-js';
