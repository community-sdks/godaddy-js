...
```js
import { Client, Config, GetListingsRequest } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, DeleteListingsRequest } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, AddExpiryListingsRequest } from '@community-sdks/godaddy-js';
