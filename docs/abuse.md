...
```js
import { Client, Config, GetTicketsRequest } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, CreateTicketRequest } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, GetTicketInfoRequest } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, GetTicketsV2Request } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, CreateTicketV2Request } from '@community-sdks/godaddy-js';
...
```js
import { Client, Config, GetTicketInfoV2Request } from '@community-sdks/godaddy-js';
